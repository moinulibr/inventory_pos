                             ...
                             <div class="row">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="purchase_price" type="number" min="0" class="form-control" placeholder="Purchase Price">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="sale_price" type="number" min="0" class="form-control" placeholder="Sale Price (Regular Price)">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="whole_sale_price" type="number" min="0" class="form-control" placeholder="whole Sale Price">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="mrp_price" type="number" min="0" class="form-control" placeholder="MRP Price">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="online_sell_price" type="number" min="0" class="form-control" placeholder="Online Sale Price">
                                ...
                                {{--   <div class="col-sm-3">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="low_sale_qty" type="number" min="0" placeholder="Low Sale Qty" class="form-control">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="low_alert_qty" type="number" min="0" placeholder="Low Alert Qty" class="form-control">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="warranty_period" type="number" step="any" placeholder="Warranty Period" class="form-control">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="guarantee_period" type="number" step="any" placeholder="Guarantee Period" class="form-control">
                                 ...
                                 <div class="col-sm-3">
                                     <div class="form-group">
                                         ...
                                         <input name="expiry_period" type="number" step="any" placeholder="Expiry Period" class="form-control">
