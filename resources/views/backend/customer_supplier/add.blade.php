 @extends('home')
 @section('title','Add Customer or Supplier')
 @section('content')
 <!-- Page Content -->
 <div class="page-content">
     ...
     <div class="page-breadcrumbs">
         <ul class="breadcrumb">
             ...
             <li class="active">Add Customer or Supplier</li>
         </ul>
     </div>
     <!-- /Page Breadcrumb -->
     <!-- Page Header -->
             ...
             <div class="col-xs-12 col-md-12">
                 <div class="widget">
                     <div class="widget-header bg-info">
                         <span class="widget-caption" style="font-size: 20px">Add Customer or Supplier</span>
