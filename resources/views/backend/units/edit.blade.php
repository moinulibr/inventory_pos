             ...
             <div class="col-xs-12 col-md-12">
                 <div class="widget">
                     <div class="widget-header bg-info">
                         <span class="widget-caption" style="font-size: 20px">Edit Units</span>
                              ...
                              <div class="row">
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input value="{{$unit->full_name}}" name="full_name" type="text" placeholder="Full name" class="form-control">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input value="{{$unit->short_name}}" name="short_name" type="text" placeholder="Short Name" class="form-control">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <select id="" name="parent_id" class="form-control">
                                            ...
                                            <option {{$unit->parent_id == 0 ?'selected' : ''}} value="0">Empty Parent Unit Name</option>
                                            @foreach ($units as $item)
                                                <option {{$unit->parent_id == $item->id?'selected':''}} value="{{$item->id}}">{{$item->short_name}}</option>
                                            @endforeach
                                         </select>
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input value="{{$unit->calculation_value}}" name="calculation_value" type="number" step="any" placeholder="Calculation By This Value" class="form-control">
                                  ...
                                  <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <select id="" name="base_unit_id" class="form-control">
                                            ...
                                            <option  {{$unit->base_unit_id == 0 ?'selected' : ''}} value="0">Empty Base Unit Name</option>
                                            @foreach ($units as $item)
                                                <option {{$unit->base_unit_id == $item->id?'selected':''}} value="{{$item->id}}">{{$item->short_name}}</option>
                                            @endforeach
                                         </select>
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input value="{{$unit->description}}" name="description" type="text" placeholder="Description" class="form-control">
