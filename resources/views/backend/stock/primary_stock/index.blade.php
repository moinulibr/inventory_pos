                                           ...
                                           @foreach($stocks as $stock)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    --}}
                                                    @php
                                                       $avl_stock = availableStock_HH($stock->productVariations?$stock->productVariations->defaultPurchaseUnits?$stock->productVariations->default_purchase_unit_id:NULL:NULL,$stock->available_stock);
                                                       $used_stock = availableStock_HH($stock->productVariations?$stock->productVariations->defaultPurchaseUnits?$stock->productVariations->default_purchase_unit_id:NULL:NULL,$stock->used_stock);
                                                    @endphp
